...
**********************************************************************************************************
  ...
  PURPOSE:
    This script performs comprehensive data quality checks on the Silver layer tables
    to ensure data integrity, consistency, and readiness for analytics and reporting.

  CHECKS INCLUDED:
    ✔ Primary key uniqueness and duplicate detection
    ✔ Null value validation
    ✔ Whitespace and formatting issues in text fields
    ✔ Standardization and consistency checks for categorical data
    ✔ Referential integrity between Silver tables
    ✔ Business rule validation (sales logic, pricing, quantities)
    ✔ Date validity and logical correctness checks
  ...
  EXPECTATION:
    All queries should return ZERO rows if data quality is correct.
  ...
  NOTES:
    This script is used for manual validation and debugging of ETL pipeline outputs.
    It can also be integrated into automated data quality testing frameworks in production.
